...
final class Permission
{
    ...
    public const VIEW_TICKET_HISTORY  = 'visualizar_historico_chamado';
    ...
    //GRUPO: DEPARTAMENTOS
    public const VIEW_DEPARTMENT  = 'ver_departamento';
    ...
    public const MANAGE_SESSION  = 'gerenciar_sessoes';
